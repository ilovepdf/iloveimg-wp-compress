...
if (!class_exists('iLoveIMGAdminPageFramework_Registry', false)):
    abstract class iLoveIMGAdminPageFramework_Registry_Base {
    ...
    final class iLoveIMGAdminPageFramework_Registry extends iLoveIMGAdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['iLoveIMGAdminPageFramework_RegisterClasses']) ? self::$aClassFiles['iLoveIMGAdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('iLoveIMGAdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['iLoveIMGAdminPageFramework_InclusionClassFilesHeader']);
        }
    ...
    if (!class_exists('iLoveIMGAdminPageFramework_Bootstrap', false)):
        final class iLoveIMGAdminPageFramework_Bootstrap {
            static private $_bLoaded = false;
            public function __construct($sLibraryPath) {
                if (!$this->_isLoadable()) {
                    return;
                }
                iLoveIMGAdminPageFramework_Registry::setUp($sLibraryPath);
                if (iLoveIMGAdminPageFramework_Registry::$bIsMinifiedVersion) {
                    return;
                }
                $this->_include();
            }
            ...
            private function _include() {
                include (iLoveIMGAdminPageFramework_Registry::$sAutoLoaderPath);
                new iLoveIMGAdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('iLoveIMGAdminPageFramework_MinifiedVersionHeader', 'iLoveIMGAdminPageFramework_BeautifiedVersionHeader',),), iLoveIMGAdminPageFramework_Registry::$aClassFiles);
                self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
                if (self::$_bXDebug) {
                    new iLoveIMGAdminPageFramework_Utility;
                    new iLoveIMGAdminPageFramework_WPUtility;
                }
            }
            static private $_bXDebug;
        }
        new iLoveIMGAdminPageFramework_Bootstrap(__FILE__);
    endif;
