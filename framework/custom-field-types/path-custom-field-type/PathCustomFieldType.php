 ...
 * @package     iLoveIMGAdminPageFramework
 */

if ( ! class_exists( 'iLoveIMGPathCustomFieldType' ) ) :
/**
 ...
 */
class iLoveIMGPathCustomFieldType extends iLoveIMGAdminPageFramework_FieldType_image {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery().registeriLoveIMGAdminPageFrameworkCallbacks( {
                /**
    ...
    public function getField( $aField ) {
        ...
        return
            $aField[ 'before_label' ]
            . "<div class='iloveimg-input-label-container iloveimg-input-container {$aField[ 'type' ]}-field'>" 
                . "<label for='{$aField[ 'input_id' ]}'>"
                    . $aField[ 'before_input' ]
                    . $this->getAOrB(
                        $aField[ 'label' ] && ! $aField[ 'repeatable' ],
                        "<span " . $this->getLabelContainerAttributes( $aField, 'iloveimg-input-label-string' ) . ">" 
                            . $aField[ 'label' ] 
                        . "</span>",                        
                        ''                        
                    )
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='iloveimg-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
jQuery( document ).ready( function(){   
    //setiLoveIMGAdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}' );
});
JAVASCRIPTS;
                    
            return "<script type='text/javascript' class='iloveimg-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
                ...
                return "<a " . $this->getAttributes( $_aAttributes ) . ">"
                        . $this->getAOrB( 
                            ...
                            $this->getAOrB(
                                ...
                                '',
                                __( 'Select Path', 'iloveimg-field-type-pack' )
                            )
                        )
                    ."</a>";
