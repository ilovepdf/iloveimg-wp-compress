...
if ( ! class_exists( 'iLoveIMGToggleCustomFieldType' ) ) :
/**
 ...
 */
class iLoveIMGToggleCustomFieldType extends iLoveIMGAdminPageFramework_FieldType_checkbox {
    ...
    protected function getScripts() {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.iloveimg-field' )
                    .children( '.iloveimg-checkbox-container-toggle' )
                    .hide();
