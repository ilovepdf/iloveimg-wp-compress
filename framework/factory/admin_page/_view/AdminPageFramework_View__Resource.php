...
class iLoveIMGAdminPageFramework_View__Resource extends iLoveIMGAdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new iLoveIMGAdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new iLoveIMGAdminPageFramework_Format_PageResource_Script($asPageScript);
