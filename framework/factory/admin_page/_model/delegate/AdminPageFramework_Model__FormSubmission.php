...
abstract class iLoveIMGAdminPageFramework_Model__FormSubmission_Base extends iLoveIMGAdminPageFramework_Form_Utility {
    ...
    class iLoveIMGAdminPageFramework_Model__FormSubmission extends iLoveIMGAdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new iLoveIMGAdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new iLoveIMGAdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
