...
class iLoveIMGAdminPageFramework_Model__FormSubmission__Validator_Base extends iLoveIMGAdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class iLoveIMGAdminPageFramework_Model__FormSubmission__Validator extends iLoveIMGAdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__Link', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__Redirect', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__Import', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__Export', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__Reset', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new iLoveIMGAdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
