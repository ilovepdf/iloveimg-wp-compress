...
abstract class iLoveIMGAdminPageFramework_CustomSubmitFields extends iLoveIMGAdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class iLoveIMGAdminPageFramework_ExportOptions extends iLoveIMGAdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo iLoveIMGAdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
