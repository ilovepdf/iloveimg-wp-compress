...
class iLoveIMGAdminPageFramework_Property_admin_page extends iLoveIMGAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'iloveimg') {
        ...
        $GLOBALS['aiLoveIMGAdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aiLoveIMGAdminPageFramework', 'aPageClasses'));
        $GLOBALS['aiLoveIMGAdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
