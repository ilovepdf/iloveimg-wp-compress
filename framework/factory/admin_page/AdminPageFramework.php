...
abstract class iLoveIMGAdminPageFramework_Router extends iLoveIMGAdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'iloveimg') {
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'iLoveIMGAdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new iLoveIMGAdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class iLoveIMGAdminPageFramework_Model_Form extends iLoveIMGAdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'iloveimg') {
            ...
            new iLoveIMGAdminPageFramework_Model__FormEmailHandler($this);
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new iLoveIMGAdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class iLoveIMGAdminPageFramework_View_Form extends iLoveIMGAdminPageFramework_Model_Form {
    ...
    abstract class iLoveIMGAdminPageFramework_Controller_Form extends iLoveIMGAdminPageFramework_View_Form {
        ...
        public function getValue() {
            ...
            return iLoveIMGAdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
        }
    ...
    abstract class iLoveIMGAdminPageFramework_Model_Page extends iLoveIMGAdminPageFramework_Controller_Form {
        public function _replyToFinalizeInPageTabs() {
            ...
            foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
                ...
                $_oFormatter = new iLoveIMGAdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
    ...
    abstract class iLoveIMGAdminPageFramework_View_Page extends iLoveIMGAdminPageFramework_Model_Page {
        public function _replyToEnablePageMetaBoxes() {
            new iLoveIMGAdminPageFramework_View__PageMetaboxEnabler($this);
        }
        public function _replyToEnqueuePageAssets() {
            new iLoveIMGAdminPageFramework_View__Resource($this);
        }
        ...
        protected function _renderPage($sPageSlug, $sTabSlug = null) {
            $_oPageRenderer = new iLoveIMGAdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
            $_oPageRenderer->render();
        }
    }
    abstract class iLoveIMGAdminPageFramework_Controller_Page extends iLoveIMGAdminPageFramework_View_Page {
    ...
    abstract class iLoveIMGAdminPageFramework_Model_Menu extends iLoveIMGAdminPageFramework_Controller_Page {
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'iloveimg') {
            parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
            new iLoveIMGAdminPageFramework_Model_Menu__RegisterMenu($this);
        }
    }
    abstract class iLoveIMGAdminPageFramework_View_Menu extends iLoveIMGAdminPageFramework_Model_Menu {
    }
    abstract class iLoveIMGAdminPageFramework_Controller_Menu extends iLoveIMGAdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new iLoveIMGAdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new iLoveIMGAdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
            $_aSubMenuPage = $_oFormatter->get();
            $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
        }
    }
    abstract class iLoveIMGAdminPageFramework_Model extends iLoveIMGAdminPageFramework_Controller_Menu {
    }
    abstract class iLoveIMGAdminPageFramework_View extends iLoveIMGAdminPageFramework_Model {
        public function content($sContent) {
            return $sContent;
        }
    }
    abstract class iLoveIMGAdminPageFramework_Controller extends iLoveIMGAdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new iLoveIMGAdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
        ...
        static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
            return iLoveIMGAdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
        }
    }
    abstract class iLoveIMGAdminPageFramework extends iLoveIMGAdminPageFramework_Controller {
        protected $_sStructureType = 'admin_page';
        public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'iloveimg') {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? iLoveIMGAdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
