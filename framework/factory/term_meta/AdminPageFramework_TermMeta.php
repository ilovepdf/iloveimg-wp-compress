...
abstract class iLoveIMGAdminPageFramework_TermMeta_Router extends iLoveIMGAdminPageFramework_TaxonomyField_Controller {
    }
    abstract class iLoveIMGAdminPageFramework_TermMeta_Model extends iLoveIMGAdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new iLoveIMGAdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class iLoveIMGAdminPageFramework_TermMeta_View extends iLoveIMGAdminPageFramework_TermMeta_Model {
    ...
    abstract class iLoveIMGAdminPageFramework_TermMeta_Controller extends iLoveIMGAdminPageFramework_TermMeta_View {
    }
    abstract class iLoveIMGAdminPageFramework_TermMeta extends iLoveIMGAdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'iloveimg') {
