...
abstract class iLoveIMGAdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        iLoveIMGAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return iLoveIMGAdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        iLoveIMGAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return iLoveIMGAdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        iLoveIMGAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        iLoveIMGAdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        iLoveIMGAdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'iLoveIMGAdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_VariableType extends iLoveIMGAdminPageFramework_Utility_Deprecated {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_String extends iLoveIMGAdminPageFramework_Utility_VariableType {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_Array extends iLoveIMGAdminPageFramework_Utility_String {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_ArrayGetter extends iLoveIMGAdminPageFramework_Utility_Array {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_ArraySetter extends iLoveIMGAdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_Path extends iLoveIMGAdminPageFramework_Utility_ArraySetter {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_URL extends iLoveIMGAdminPageFramework_Utility_Path {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_File extends iLoveIMGAdminPageFramework_Utility_URL {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_SystemInformation extends iLoveIMGAdminPageFramework_Utility_File {
    ...
    abstract class iLoveIMGAdminPageFramework_Utility_HTMLAttribute extends iLoveIMGAdminPageFramework_Utility_SystemInformation {
    ...
    class iLoveIMGAdminPageFramework_Utility extends iLoveIMGAdminPageFramework_Utility_HTMLAttribute {
