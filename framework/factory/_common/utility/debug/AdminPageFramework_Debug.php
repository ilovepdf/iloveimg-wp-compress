...
class iLoveIMGAdminPageFramework_Debug_Base extends iLoveIMGAdminPageFramework_FrameworkUtility {
    ...
    class iLoveIMGAdminPageFramework_Debug_Log extends iLoveIMGAdminPageFramework_Debug_Base {
    ...
    class iLoveIMGAdminPageFramework_Debug extends iLoveIMGAdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('iLoveIMGAdminPageFramework_Debug::' . __FUNCTION__, 'iLoveIMGAdminPageFramework_Debug::dump()');
            iLoveIMGAdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('iLoveIMGAdminPageFramework_Debug::' . __FUNCTION__, 'iLoveIMGAdminPageFramework_Debug::get()');
            return iLoveIMGAdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('iLoveIMGAdminPageFramework_Debug::' . __FUNCTION__, 'iLoveIMGAdminPageFramework_Debug::log()');
            iLoveIMGAdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('iLoveIMGAdminPageFramework_Debug::' . __FUNCTION__);
