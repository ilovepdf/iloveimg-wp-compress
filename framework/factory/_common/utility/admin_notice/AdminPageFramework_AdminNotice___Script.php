...
class iLoveIMGAdminPageFramework_AdminNotice___Script extends iLoveIMGAdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.iloveimg-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='iloveimg-admin-notice-animation-container'></div>" );
