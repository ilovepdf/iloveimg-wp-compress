...
abstract class iLoveIMGAdminPageFramework_Property_Base extends iLoveIMGAdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'iloveimg' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aiLoveIMGAdminPageFramework'])) {
            $GLOBALS['aiLoveIMGAdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => iLoveIMGAdminPageFramework_Registry::NAME, 'sURI' => iLoveIMGAdminPageFramework_Registry::URI, 'sScriptName' => iLoveIMGAdminPageFramework_Registry::NAME, 'sLibraryName' => iLoveIMGAdminPageFramework_Registry::NAME, 'sLibraryURI' => iLoveIMGAdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => iLoveIMGAdminPageFramework_Registry::getVersion(), 'sDescription' => iLoveIMGAdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => iLoveIMGAdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => iLoveIMGAdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => iLoveIMGAdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => iLoveIMGAdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new iLoveIMGAdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
