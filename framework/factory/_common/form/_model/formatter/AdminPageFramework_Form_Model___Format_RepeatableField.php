...
class iLoveIMGAdminPageFramework_Form_Model___Format_RepeatableSection extends iLoveIMGAdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : iLoveIMGAdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class iLoveIMGAdminPageFramework_Form_Model___Format_RepeatableField extends iLoveIMGAdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
