...
class iLoveIMGAdminPageFramework_Form_Model___SetFieldResources extends iLoveIMGAdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new iLoveIMGAdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('iLoveIMGAdminPageFramework_Form_View___CSS_Form', 'iLoveIMGAdminPageFramework_Form_View___CSS_Field', 'iLoveIMGAdminPageFramework_Form_View___CSS_Section', 'iLoveIMGAdminPageFramework_Form_View___CSS_CollapsibleSection', 'iLoveIMGAdminPageFramework_Form_View___CSS_FieldError', 'iLoveIMGAdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('iLoveIMGAdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new iLoveIMGAdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new iLoveIMGAdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
