...
class iLoveIMGAdminPageFramework_Form_View___Script_MediaUploader extends iLoveIMGAdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getiLoveIMGAdminPageFrameworkCustomMediaUploaderSelectObject = function() {
