...
class iLoveIMGAdminPageFramework_Form_View___Script_SectionTab extends iLoveIMGAdminPageFramework_Form_View___Script_Base {
...
jQuery( '.iloveimg-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='iloveimg-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
