...
class iLoveIMGAdminPageFramework_Form_View___Description extends iLoveIMGAdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'iloveimg-form-element-description';
