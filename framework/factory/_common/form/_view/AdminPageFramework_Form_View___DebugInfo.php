...
class iLoveIMGAdminPageFramework_Form_View___DebugInfo extends iLoveIMGAdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='iloveimg-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
