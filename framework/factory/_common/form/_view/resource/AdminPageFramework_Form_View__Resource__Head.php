...
class iLoveIMGAdminPageFramework_Form_View__Resource__Head extends iLoveIMGAdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    public function _replyToInsertRequiredInternalScripts() {
        ...
        echo "<script type='text/javascript' class='iloveimg-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'iloveimg-js-embedded-internal-style\'>' . str_replace('\\n', '', esc_js($this->_getInternalCSS())) . '</style>" );';
    }
    private function _getInternalCSS() {
        $_oLoadingCSS = new iLoveIMGAdminPageFramework_Form_View___CSS_Loading;
    ...
    private function _getScriptElementConcealerCSSRules() {
        return ".iloveimg-form-js-on {visibility: hidden;}.widget .iloveimg-form-js-on { visibility: visible; }";
    }
    }
