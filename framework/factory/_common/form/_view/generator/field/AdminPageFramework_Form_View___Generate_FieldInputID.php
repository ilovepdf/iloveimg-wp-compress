...
class iLoveIMGAdminPageFramework_Form_View___Generate_FieldTagID extends iLoveIMGAdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class iLoveIMGAdminPageFramework_Form_View___Generate_FieldInputID extends iLoveIMGAdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
