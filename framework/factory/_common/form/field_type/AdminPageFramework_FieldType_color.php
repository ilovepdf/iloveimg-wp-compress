...
abstract class iLoveIMGAdminPageFramework_FieldType_Base extends iLoveIMGAdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : iLoveIMGAdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new iLoveIMGAdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new iLoveIMGAdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
    ...
    abstract class iLoveIMGAdminPageFramework_FieldType extends iLoveIMGAdminPageFramework_FieldType_Base {
        public function _replyToFieldLoader() {
            $this->setUp();
        }
        public function _replyToGetScripts() {
    ...
    class iLoveIMGAdminPageFramework_FieldType_color extends iLoveIMGAdminPageFramework_FieldType {
        ...
        protected function getStyles() {
            return ".repeatable .colorpicker {display: inline;}.iloveimg-field-color .wp-picker-container {vertical-align: middle;}.iloveimg-field-color .ui-widget-content {border: none;background: none;color: transparent;}.iloveimg-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.iloveimg-field-color .iloveimg-repeatable-field-buttons {margin-top: 0;}.iloveimg-field-color .wp-color-result {margin: 3px;}";
        }
        protected function getScripts() {
            $_aJSArray = json_encode($this->aFieldTypeSlugs);
            $_sDoubleQuote = '\"';
            return <<<JAVASCRIPTS
registeriLoveIMGAdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'iloveimg_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'iloveimg_field_type_color_cleared',
    ...
    jQuery().registeriLoveIMGAdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registeriLoveIMGAdminPageFrameworkColorPickerField( _oNewColorInput );                
...
JAVASCRIPTS;
        ...
        protected function getField($aField) {
            ...
            return $aField['before_label'] . "<div class='iloveimg-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'iloveimg-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
        }
...
jQuery( document ).ready( function(){
    registeriLoveIMGAdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
