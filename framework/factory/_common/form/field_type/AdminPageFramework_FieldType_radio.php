...
class iLoveIMGAdminPageFramework_FieldType_radio extends iLoveIMGAdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".iloveimg-field input[type='radio'] {margin-right: 0.5em;} .iloveimg-field-radio .iloveimg-input-label-container {padding-right: 1em;} .iloveimg-field-radio .iloveimg-input-container {display: inline;} .iloveimg-field-radio .iloveimg-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.iloveimg-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
