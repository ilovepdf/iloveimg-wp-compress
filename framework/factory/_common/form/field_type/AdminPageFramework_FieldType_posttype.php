...
class iLoveIMGAdminPageFramework_FieldType_checkbox extends iLoveIMGAdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAlliLoveIMGAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAlliLoveIMGAdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.iloveimg-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.iloveimg-checkbox-label {margin-top: 0.1em;}.iloveimg-field input[type='checkbox' ] {margin-right: 0.5em;} .iloveimg-field-checkbox .iloveimg-input-label-container {padding-right: 1em;}.iloveimg-field-checkbox .iloveimg-input-label-string{display: inline; }";
    }
    ...
    class iLoveIMGAdminPageFramework_FieldType_posttype extends iLoveIMGAdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".iloveimg-field input[type='checkbox'] {margin-right: 0.5em;} .iloveimg-field-posttype .iloveimg-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
