...
class iLoveIMGAdminPageFramework_FieldType_import extends iLoveIMGAdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".iloveimg-field-import input {margin-right: 0.5em;}.iloveimg-field-import label,.form-table td fieldset.iloveimg-fieldset .iloveimg-field-import label { display: inline; }";
    }
