...
class iLoveIMGAdminPageFramework_FieldType_submit extends iLoveIMGAdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".iloveimg-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'iloveimg-input-label-container' . ' iloveimg-input-button-container' . ' iloveimg-input-container',);
    }
    ...
    class iLoveIMGAdminPageFramework_FieldType_export extends iLoveIMGAdminPageFramework_FieldType_submit {
