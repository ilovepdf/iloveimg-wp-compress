...
class iLoveIMGAdminPageFramework_Form___SubmitNotice extends iLoveIMGAdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new iLoveIMGAdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new iLoveIMGAdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
