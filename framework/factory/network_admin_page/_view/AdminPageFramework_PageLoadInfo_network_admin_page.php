...
class iLoveIMGAdminPageFramework_PageLoadInfo_network_admin_page extends iLoveIMGAdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new iLoveIMGAdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
