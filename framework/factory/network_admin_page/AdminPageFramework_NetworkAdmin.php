...
abstract class iLoveIMGAdminPageFramework_NetworkAdmin extends iLoveIMGAdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'iloveimg') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $sCallerPath = $sCallerPath ? $sCallerPath : iLoveIMGAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new iLoveIMGAdminPageFramework_Model_Menu__RegisterMenu($this, 'network_admin_menu');
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return iLoveIMGAdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
    }
