...
abstract class iLoveIMGAdminPageFramework_UserMeta_Router extends iLoveIMGAdminPageFramework_Factory {
    ...
    abstract class iLoveIMGAdminPageFramework_UserMeta_Model extends iLoveIMGAdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new iLoveIMGAdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class iLoveIMGAdminPageFramework_UserMeta_View extends iLoveIMGAdminPageFramework_UserMeta_Model {
    ...
    abstract class iLoveIMGAdminPageFramework_UserMeta_Controller extends iLoveIMGAdminPageFramework_UserMeta_View {
    ...
    abstract class iLoveIMGAdminPageFramework_UserMeta extends iLoveIMGAdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'iloveimg') {
