...
class iLoveIMGAdminPageFramework_Property_post_meta_box extends iLoveIMGAdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'iloveimg', $sStructureType = 'post_meta_box') {
