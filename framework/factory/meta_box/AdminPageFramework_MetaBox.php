...
abstract class iLoveIMGAdminPageFramework_MetaBox_Router extends iLoveIMGAdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'iloveimg') {
    ...
    abstract class iLoveIMGAdminPageFramework_MetaBox_Model extends iLoveIMGAdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'iloveimg') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new iLoveIMGAdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class iLoveIMGAdminPageFramework_MetaBox_View extends iLoveIMGAdminPageFramework_MetaBox_Model {
    ...
    abstract class iLoveIMGAdminPageFramework_MetaBox_Controller extends iLoveIMGAdminPageFramework_MetaBox_View {
    ...
    abstract class iLoveIMGAdminPageFramework_MetaBox extends iLoveIMGAdminPageFramework_MetaBox_Controller {
