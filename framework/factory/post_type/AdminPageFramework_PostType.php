...
abstract class iLoveIMGAdminPageFramework_PostType_Router extends iLoveIMGAdminPageFramework_Factory {
    ...
    abstract class iLoveIMGAdminPageFramework_PostType_Model extends iLoveIMGAdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new iLoveIMGAdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new iLoveIMGAdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class iLoveIMGAdminPageFramework_PostType_View extends iLoveIMGAdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='iloveimg-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class iLoveIMGAdminPageFramework_PostType_Controller extends iLoveIMGAdminPageFramework_PostType_View {
    ...
    abstract class iLoveIMGAdminPageFramework_PostType extends iLoveIMGAdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'iloveimg') {
            if (empty($sPostType)) {
                return;
            }
            $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'iLoveIMGAdminPageFramework_Property_' . $this->_sStructureType;
            ...
            $this->oProp->sPostType = iLoveIMGAdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = iLoveIMGAdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return iLoveIMGAdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
