...
abstract class iLoveIMGAdminPageFramework_Widget_Router extends iLoveIMGAdminPageFramework_Factory {
    ...
    abstract class iLoveIMGAdminPageFramework_Widget_Model extends iLoveIMGAdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new iLoveIMGAdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class iLoveIMGAdminPageFramework_Widget_View extends iLoveIMGAdminPageFramework_Widget_Model {
    ...
    abstract class iLoveIMGAdminPageFramework_Widget_Controller extends iLoveIMGAdminPageFramework_Widget_View {
    ...
    abstract class iLoveIMGAdminPageFramework_Widget extends iLoveIMGAdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'iloveimg');
