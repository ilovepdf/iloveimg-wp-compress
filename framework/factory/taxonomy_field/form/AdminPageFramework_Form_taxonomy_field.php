...
class iLoveIMGAdminPageFramework_Form_taxonomy_field extends iLoveIMGAdminPageFramework_Form {
    ...
    public function get() {
        ...
        $_oFieldsets = new iLoveIMGAdminPageFramework_Form_View___FieldsetRows($this->getElementAsArray($this->aFieldsets, '_default'), null, $this->aSavedData, $this->getFieldErrors(), $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
