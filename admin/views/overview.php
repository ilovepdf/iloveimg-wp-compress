<div class="iloveimg_settings__overview__statistics">
	...
	<div>
		<div class="iloveimg_settings__overview__statistics__column_left">
			<?php $images_sizes = iLoveIMG_Compress_Resources::get_files_sizes(); ?>
		...
		<div class="iloveimg_settings__overview__statistics__column_right">
			<h4>Original Compressed images <strong><?php echo iLoveIMG_Compress_Resources::get_files_compressed(); ?></strong> / Uploaded images <strong><?php echo iLoveIMG_Compress_Resources::get_total_images(); ?></strong></h4>
			<div class="iloveimg_percent  ">
                <div class="iloveimg_percent-total" style="width: <?php echo ( iLoveIMG_Compress_Resources::get_total_images() > 0 ) ? round( ( iLoveIMG_Compress_Resources::get_files_compressed() * 100 ) / iLoveIMG_Compress_Resources::get_total_images() ) : 0; ?>%;"></div>
            </div>
            <div class="iloveimg_saving">
            	<p class="iloveimg_saving__number"><?php echo ( iLoveIMG_Compress_Resources::get_total_images() > 0 ) ? round( ( iLoveIMG_Compress_Resources::get_files_compressed() * 100 ) / iLoveIMG_Compress_Resources::get_total_images() ) : 0; ?>%</p>
