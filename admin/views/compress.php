        ...
        <div class="iloveimg_settings__options-nav">
            <ul>
                <li class="iloveimg_settings__options-nav__selected">
                    <a href="<?php echo admin_url( 'admin.php?page=iloveimg-admin-page' ) ?>">
        ...
        <div class="iloveimg_settings__options-container">
            <form method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>">
                ...
                <div class="iloveimg_settings__options__field" style="margin-bottom: 30px">
                    ...
                    <p>Any uploaded image bigger than market here, will be resized to not exceed exceed these width and height boundaries. All resized will be made according to the aspect ratio of the original image.</p>
