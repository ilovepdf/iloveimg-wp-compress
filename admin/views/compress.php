<div class="wrap">
    ...
    <form method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>">
        ...
        <div>
            ...
            <input type="checkbox" name="iloveimg_field_compress_activated" <?php echo $options_value['iloveimg_field_compress_activated'] ? "checked" : ""  ?> />
        </div>

        <div>
            <label>Enable Autocompress Images:</label>
            <input type="checkbox" name="iloveimg_field_autocompress" <?php echo $options_value['iloveimg_field_autocompress'] ? "checked" : ""  ?> />
        </div>
        ...
        <div>
            ...
            <input type="checkbox" name="iloveimg_field_resize_full" <?php echo $options_value['iloveimg_field_resize_full'] ? "checked" : ""  ?> />
