    ...
    <?php if ( 'register' !== $ilove_img_get_section ) : ?>
        <div class="iloveimg_settings__overview__account iloveimg_settings__overview__account-login">
            ...
            <form method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>" autocomplete="off">
                ...
                <h3><?php echo esc_html_x( 'Log in to your account', 'form title', 'iloveimg' ); ?></h3>
                ...
                <a class="forget" href="https://iloveapi.com/login/reset" target="_blank"><?php echo esc_html_x( 'Forgot your password?', 'button', 'iloveimg' ); ?></a>
                <?php
                wp_nonce_field();
                submit_button( _x( 'Log in', 'button', 'iloveimg' ) );
                ?>
                <div>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=iloveimg-compress-admin-page&section=register' ) ); ?>"><?php esc_html_e( 'Create an iLoveAPI account', 'iloveimg' ); ?></a>
                </div>
            </form>
        </div>
    <?php else : ?>
        <div class="iloveimg_settings__overview__account iloveimg_settings__overview__account-register">
            ...
            <form method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>" autocomplete="off">
                <input type="hidden" name="action" value="update_compress" />
                <h3><?php esc_html_e( 'Create an iLoveAPI account', 'iloveimg' ); ?></h3>
                ...
                <?php
                wp_nonce_field();
                submit_button( _x( 'Sign up', 'button', 'iloveimg' ) );
                ?>
                <div>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=iloveimg-compress-admin-page' ) ); ?>"><?php echo esc_html_x( 'Log in to your account', 'button', 'iloveimg' ); ?></a>
                </div>
            </form>
        </div>
    <?php endif; ?>
        ...
        <div class="iloveimg_settings__overview__account-logged__column_left">
            <div class="iloveimg_settings__overview__account-logged__column_left__stadistics">
                ...
                <?php if ( $ilove_img_account['subscription_files_limit'] ) : ?>
                    <h4><?php echo esc_html_x( 'Monthly plan', 'subtitle section: subscription credits', 'iloveimg' ); ?></h4>
                    <?php
                    $ilove_img_percent = 0;
                    ...
                    <p>
                        ...
                        printf(
                            /* translators: %1$d: credits used / %2$d: credits limit */
                            esc_html__( '%1$d / %2$d credits used this month.', 'iloveimg' ),
                ...
                <?php if ( $ilove_img_account['package_files_limit'] ) : ?>
                    <h4><?php echo esc_html_x( 'Packages', 'subtitle section: package credits', 'iloveimg' ); ?></h4>
            ...
            <div class="iloveimg_settings__overview__account-logged__column_left__details">
                <p style="margin-top: 22px;">
                    ...
                    printf(
                        ...
                        esc_html__( 'You get %d free credits each month to process your files.', 'iloveimg' ),
                        (int) $ilove_img_account['free_files_limit']
                    );
                    ?>
                </p>
