...
1. **Click the ëInstall Nowí button**. WordPress will download and install the plugin for you.
...
Yes, we do. You can integrate our image optimization tools into your software apps. Learn more about iLoveIMG API for developers.
